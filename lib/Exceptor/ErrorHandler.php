 ...
 *
 * $client = new Exceptor_Client('http://public:secret/example.com/1');
 * $error_handler = new Exceptor_ErrorHandler($client);
...
class Exceptor_ErrorHandler
{
    ...
    {
        if (!defined('EXCEPTOR_CLIENT_END_REACHED')) {
            define('EXCEPTOR_CLIENT_END_REACHED', true);
        }
    }
}
