...
class Exceptor_Stacktrace
{
    ...
    public static function get_stack_info($frames, $trace = false, $shiftvars = true, $errcontext = null,
                            $frame_var_limit = Exceptor_Client::MESSAGE_LIMIT)
    {
        /**
    ...
    public static function get_frame_context($frame, $frame_arg_limit = Exceptor_Client::MESSAGE_LIMIT)
    {
